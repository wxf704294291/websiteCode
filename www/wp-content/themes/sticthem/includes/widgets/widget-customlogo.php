...
?>
<div class="clearfix">
	<img id="footer-logo" alt="" src="<?php echo esc_attr( $logoImagePath ); ?>" />
...
<?php
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
		...
		# Logo Image
		echo '<p><label for="' . $this->get_field_id('logoImagePath') . '">' . 'Logo Image URL (113x49px):' . '</label><textarea cols="20" rows="2" class="widefat" id="' . $this->get_field_id('logoImagePath') . '" name="' . $this->get_field_name('logoImagePath') . '" >'. esc_textarea( $logoImagePath ) .'</textarea></p>';
		# Copyright
