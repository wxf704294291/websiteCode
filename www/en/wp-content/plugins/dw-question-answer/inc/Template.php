...
function dwqa_search_form() {
	...
	<form id="dwqa-search" class="dwqa-search">
		<input data-nonce="<?php echo wp_create_nonce( '_dwqa_filter_nonce' ) ?>" type="text" placeholder="<?php _e( 'Search for the answer you want...', 'dwqa' ); ?>" name="qs" value="<?php echo isset( $_GET['qs'] ) ? esc_html( $_GET['qs'] ) : '' ?>">
	</form>
	<?php
}
